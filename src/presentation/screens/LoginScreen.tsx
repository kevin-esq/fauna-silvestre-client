...
import {Credentials} from "../../domain/models/AuthModels";
  ...
  const handleLogin = useCallback(async () => {
   ...
   // const validationError = validateLoginFields(trimmedUsername, password);
    ...
    try {
      ...
      if (auth.isAuthenticated) console.log("[LoginScreen] token", auth.user?.token);
    } catch (localError) {
      setError("Nombre de usuario o contraseña incorrectos");
      console.log("error", localError);
    }
  }, [username, password, rememberMe, auth, navigation]);

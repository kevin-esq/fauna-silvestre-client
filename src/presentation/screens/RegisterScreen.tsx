...
import { RegisterAction } from "../../domain/types/RegisterAction";
import { NavigateReset } from "../../shared/utils/navigation";
import {useAuth} from "../contexts/AuthContext";
import {UserData} from "../../domain/models/AuthModels";
...
const RegisterScreen = ({ navigation }: { navigation: NavigationProp<any, any> }) => {
  ...
  const handleRegister = useCallback(async () => {
    ...
    const index = genderOptions.findIndex((option) => option.value === gender);

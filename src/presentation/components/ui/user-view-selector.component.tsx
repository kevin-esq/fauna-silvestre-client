...
const SORT_OPTIONS: Array<{
  ...
  { value: 'email-asc', label: 'Email (A-Z)', icon: 'mail-outline' },
  { value: 'email-desc', label: 'Email (Z-A)', icon: 'mail-outline' },
  { value: 'location-asc', label: 'Ubicación (A-Z)', icon: 'location-outline' },
  {
    value: 'location-desc',
    label: 'Ubicación (Z-A)',
    icon: 'location-outline'
  },
  { value: 'date-asc', label: 'Más antiguos', icon: 'calendar-outline' },
  { value: 'date-desc', label: 'Más recientes', icon: 'calendar-outline' }
];
